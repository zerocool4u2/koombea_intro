...
RSpec.describe CsvFile, type: :model do
  describe 'validations' do
    ...
    describe 'with formatted headers' do
      ...
      it { is_expected.to_not validate_presence_of(:name_column) }
      it { is_expected.to_not validate_presence_of(:birthday_column) }
      it { is_expected.to_not validate_presence_of(:phone_column) }
      it { is_expected.to_not validate_presence_of(:address_column) }
      it { is_expected.to_not validate_presence_of(:credit_card_number_column) }
      it { is_expected.to_not validate_presence_of(:email_column) }
    end
    ...
    describe 'without headers' do
      subject { build(:csv_file, headers: false) }
